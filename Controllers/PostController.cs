...
namespace BloggingPlatform.Controllers
{
    public class PostController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Title,Content,PublishedDate,BlogId")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("PostId,Title,Content,PublishedDate,BlogId")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
